...
from .views import (
    ...
    KidsVideoCategoryListView, KidsVideoListView, KidsVideoDetailView,
...
urlpatterns = [
    ...
    path("kids/videos/categories/", KidsVideoCategoryListView.as_view(), name="kids-video-categories"),
    path("kids/videos/", KidsVideoListView.as_view(), name="kids-videos"),
    path("kids/videos/<int:video_id>/", KidsVideoDetailView.as_view(), name="kids-video-detail"),
    ...
    path("parent-store/tags/", ParentStoreTagListView.as_view(), name="parent-store-tags"),
...
urlpatterns += [
    ...
    path("admin/kids/video-categories/", AdminKidsVideoCategoryListCreate.as_view(), name="admin-kids-video-cat-list"),
    path("admin/kids/video-categories/<int:cat_id>/", AdminKidsVideoCategoryDetail.as_view(), name="admin-kids-video-cat-detail"),
    path("admin/kids/videos/", AdminKidsVideoListCreate.as_view(), name="admin-kids-video-list"),
    path("admin/kids/videos/<int:video_id>/", AdminKidsVideoDetail.as_view(), name="admin-kids-video-detail"),
