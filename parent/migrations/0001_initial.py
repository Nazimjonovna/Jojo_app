        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "source",
                    models.CharField(
                        choices=[("rest", "REST"), ("websocket", "WebSocket")],
                        default="rest",
                        max_length=20,
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="alerts",
                        to="parent.childrouteassignment",
                    ),
                ),
                (
                    "child",
            ...
            options={
                "indexes": [
                    models.Index(
                        ...
                        name="parent_devi_user_id_0b72e7_idx",
                    ),
                    models.Index(
                        fields=["user", "is_active"],
                        name="parent_devi_user_id_45806e_idx",
                    ),
                ],
            },
        ),
